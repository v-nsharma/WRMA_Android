...
Mobile.waitForElementPresent(findTestObject('Object Repository/Repo/android.widget.Button - back-errormessage'), 15)

Mobile.tap(findTestObject('Object Repository/Repo/android.widget.Button - back-errormessage'), 0)
