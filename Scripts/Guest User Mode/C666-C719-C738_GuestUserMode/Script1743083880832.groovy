...
String actualVersionText = Mobile.getText(findTestObject('Object Repository/Repo/android.widget.Button - Version 2.81.111'), 0)

'Verify application version'
String expectedVersionText = "Version 2.81.111"
