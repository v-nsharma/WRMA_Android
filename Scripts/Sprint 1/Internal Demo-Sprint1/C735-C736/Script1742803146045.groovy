...
Mobile.startApplication('C:\\Users\\GVVignesh\\git\\WGR_Android\\App Folder\\app-debug.apk', true, FailureHandling.STOP_ON_FAILURE)
Mobile.delay(5)
...
Mobile.setText(findTestObject('Object Repository/Repo/android.widget.EditText-OAM(Login)'), email, 0, FailureHandling.STOP_ON_FAILURE)
Mobile.hideKeyboard()
Mobile.delay(30)

'Enter the password in the OAM password field'
Mobile.setText(findTestObject('Object Repository/Repo/android.widget.EditText-OAM(Password)'), password, 0, FailureHandling.STOP_ON_FAILURE)
Mobile.hideKeyboard()
Mobile.delay(30)
