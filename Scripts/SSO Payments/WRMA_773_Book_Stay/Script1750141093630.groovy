...
Mobile.tap(findTestObject('Object Repository/SS0Manage/android.widget.Button - BOOK YOUR ROOM'), 0)
...
'Verify the presence of "MAKE A PAYMENT" button on the screen'
assert Mobile.verifyElementExist(findTestObject('Object Repository/SS0Manage/android.widget.Button - MAKE A PAYMENT'), 0)
