...
assert Mobile.verifyElementExist(findTestObject('Object Repository/Repo/android.widget.TextView - Youre Moments Away FromCustomized Vacation Experiences'),
	0)
...
assert Mobile.verifyElementExist(findTestObject('Object Repository/Repo/android.widget.Button - Login or Sign Up'), 0)

'Wait for 3 seconds'
Mobile.delay(3)

'Verify the bottom navigation bar "Home" is present'
assert Mobile.verifyElementExist(findTestObject('Object Repository/Repo/android.view.View - Home'), 0)

'Wait for 3 seconds'
Mobile.delay(3)

'Verify the bottom navigation bar "My Account" is present'
assert Mobile.verifyElementExist(findTestObject('Object Repository/Repo/android.view.View - My Account'), 0)
...
assert Mobile.verifyElementVisible(findTestObject('Object Repository/Repo/android.widget.TextView - Vacation More. Get More'),
	0)
...
assert Mobile.verifyElementVisible(findTestObject('Object Repository/Repo/android.widget.TextView - Explore Westgate Loyalty'),
	0)
...
//if (!(isElementVisible)) {
//	KeywordUtil.markFailed('Success: Tapped on \'Continue as a Guest\' and expected element is present.')
//} else {
//	KeywordUtil.logInfo('Failed: Expected element not found after tapping \'Continue as a Guest.')
//}
//
//'Wait for 15 seconds'
//Mobile.delay(10)
